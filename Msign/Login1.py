...
class login_system:
    ...
    # Create Widgets
        ...
        self.bg1_icon=ImageTk.PhotoImage(file=r"D:\All project\Msign\L.jpg")

        self.bg_icon=ImageTk.PhotoImage(file=r"D:\All project\Msign\L.jpg")
        self.user_icon=ImageTk.PhotoImage(file=r"D:\All project\Msign\u1.png")
        self.pass_icon=ImageTk.PhotoImage(file=r"D:\All project\Msign\p1.jpg")
